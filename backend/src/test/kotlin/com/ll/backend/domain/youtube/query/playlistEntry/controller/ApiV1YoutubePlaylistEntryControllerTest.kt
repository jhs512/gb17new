...
class ApiV1YoutubePlaylistEntryControllerTest @Autowired constructor(
    ...
    @Test
    @DisplayName("GET /api/v1/youtube/query/playlists/$samplePlaylist1Code/entries")
    fun t01() {
        // WHEN
        val resultActions = mockMvc
            .perform(
                get("/api/v1/youtube/query/playlists/$samplePlaylist1Code/entries")
            )
    ...
    @Test
    @DisplayName("GET /api/v1/youtube/query/playlists/NOT-EXISTS/entries")
    fun t02() {
        // WHEN
        val resultActions = mockMvc
            .perform(
                get("/api/v1/youtube/query/playlists/NOT-EXISTS/entries")
            )
            .andDo(MockMvcResultHandlers.print())
