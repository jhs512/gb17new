...
class ApiV1YoutubePlaylistControllerTest @Autowired constructor(
    ...
    @Test
    @DisplayName("GET /api/v1/youtube/query/playlists/$samplePlaylist1Code")
    fun t01() {
        // WHEN
        val resultActions = mockMvc
            .perform(
                get("/api/v1/youtube/query/playlists/$samplePlaylist1Code")
            )
    ...
    @Test
    @DisplayName("GET /api/v1/youtube/query/playlists/NOT-EXISTS")
    fun t02() {
        // WHEN
        val resultActions = mockMvc
            .perform(
                get("/api/v1/youtube/query/playlists/NOT-EXISTS")
            )
            .andDo(MockMvcResultHandlers.print())
